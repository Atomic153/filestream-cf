...
const BOT_TOKEN = "8021108236:AAEEMKpq0jHDyJXrY_m_IFIRe5N7bDxI5BU"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "Babloo"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 1367244724; // Insert your telegram account id.
const BOT_CHANNEL = -1002253081088; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "Babloo"; // Insert a powerful secret text and keep it safe.
